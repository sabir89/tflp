...
$(function() {
    ...
    $('.slideshow').each(function(){
    	var nextBtn = $(this).next(".btnCont").find(".next");
    	var prevBtn = $(this).next(".btnCont").find(".prev");
    	var getcon = $(this).next('.btnCont').find(".showTot");
    	var getTot = getcon.find('.totCon');
    	var getTot2 = getcon.find('.curentCon');
    	getTot.text("/ "+$(this).find('img').length);
    	$(this).cycle({
    		prev:    prevBtn,
        	next:    nextBtn,
        	 before: function () {
    			//alert("Current slide " + (opts.currSlide));.text
    			getTot2.text($(this).attr("img_count"));
			}
    	});    
			...
			<div class="listingbody">
				...
				<div id="slideshow_container">
					...
					for ($i = 1; $i <= $photoshow; $i++){ //main photo
						...
						$istyle = "";
						if ($i > 1) $istyle = 'style="display: block;"';	
						echo "<img id=\"a${count}${i}\" $istyle src=\"$imgurl\" width=\"320\" alt=\"\" img_count=\"${i}\" />\n";
					}
					?>
					
					</div> <!-- lbleft -->
					<div class="btnCont">
				        <a href="#" class="btnCont_prev"><span id="prev" class="prev">Prev</span></a> 
				        <a href="#" class="btnCont_next"><span id="next" class="next">Next</span></a>
				        <span class="showTot">
				        	<span class="curentCon"></span>
				        	<span class="totCon"></span>
				        </span>
				    </div>
				</div>
				<?php	
