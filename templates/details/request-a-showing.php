...
//include_once("../../../../../wp-load.php");
 /*
 Template Name: Request a showing modal box
 */
 wp_head();
?>
...
<body>
 <?php gravity_form(9, $display_title=false, $display_description=false, $display_inactive=false, $field_values=array('mlnumber' => $_REQUEST['mlnumber']), $ajax=true, $tabindex);
