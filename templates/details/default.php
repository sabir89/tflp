...
<link rel="stylesheet" type="text/css" href="<?php echo WP_PLUGIN_DIR; ?>/tflp/templates/fancybox/jquery.fancybox.css" media="screen" />
<script type="text/javascript" src="<?php echo WP_PLUGIN_DIR; ?>/tflp/templates/fancybox/jquery.fancybox.pack.js"></script>
<!--
  jQuery library
-->
<script type="text/javascript" src="<?php bloginfo( 'home' ); ?>/wp-content/plugins/tflp/js/jquery-1.9.1.min.js"></script>
<!--
  jCarousel library
-->
<script type="text/javascript" src="<?php bloginfo( 'home' ); ?>/wp-content/plugins/tflp/js/jquery.jcarousel.min.js"></script>
<!--
  jCarousel skin stylesheet
-->
<link rel="stylesheet" type="text/css" href="<?php bloginfo( 'home' ); ?>/wp-content/plugins/tflp/css/skin.css" />
...
?>
		...
		<!--<div><a href="">Previous</a><a href="">Next</a></div>-->
		<div class="listingwrapper">
			<div class="listinghead">
				...
				<div class="alleft">
				<span class="aladd1">
					<?php echo $prop->streetnumber . ", " . $prop->streetname; ?>
					<?php echo $prop->streetsuffix; ?>
					<?php if($prop->streetdirsuffix) echo ",".$prop->streetdirsuffix; ?>

				</span><br />
				<span class="aladd2">
					<?php echo $prop->city . ", " . $prop->stateorprovince . " ".$prop->postalcode;?>
				</span>
				</div> <!-- alleft -->
			</div> <!-- listing head -->
			<div class="listingbody">
				...
				?>
				<?php
				if($prop->photocount>1 && $prop->status != "Sold")
				{
				?>
				
					<ul id="mycarousel" class="jcarousel-skin-tango">
					<?php
					for ($i = 1; $i <= $totalPhotos; $i++){ // thumbnail 
					?>	
						<li>
						<div>
						<?php 
						...
						?>
						<a href="javascript:" onclick="swapimgb('a<?php echo "${count}${i}"?>',<?php echo $totalPhotos;?>,<?php echo $count;?>); return false;">
				...
				<ul>
					...
					<li><!--<a href="<?php echo plugins_url()."/tflp/templates/details/"?>msimple_js.php?value=<?php echo $price;?>" target="blank">--><a href="javascript:open_window('<?php echo plugins_url()."/tflp/templates/details/"?>msimple_js.php?value=<?php echo $price;?>',330,490)">Mortgage Calculator</a></li>	
				<?php
					if($prop->vt == "true"){
...
<script src="http://maps.google.com/maps/api/js?key=AIzaSyDBKcuhNP_2KcWrZLB1C1UO25L0MdHmG5k&sensor=false" type="text/javascript"></script>			
			<script>
function initialize()
{
var myCenter=new google.maps.LatLng('<?php echo $prop->latitude; ?>','<?php echo $prop->longitude; ?>');
var mapProp = {
  center:myCenter,
  zoom:14,
...
var infowindow = new google.maps.InfoWindow({
  content:"<?php echo $address; ?><br /><?php echo $prop->city; ?>,<?php echo $prop->stateorprovince; ?>,<?php echo $prop->postalcode; ?>"
  });
